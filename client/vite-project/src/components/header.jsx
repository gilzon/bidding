      ...
      <div className="container-xxxl">
        <div className="row">
          ...
          <div className="user-pro col-6 d-flex align-items-center ">
            ...
            <div className="header-buttons d-flex justify-content-around mt-4 "><Link to='profile' >{<FaUserCircle className="profile-icon fs-3 "  onClick={() => handleIconClick('profile')}/>}</Link></div>
             <div className="d-flex"><Link to='settings'>{<FiSettings className="setting-icon" onClick={() => handleIconClick('settings')}/>}</Link>
             </div>
